...
Når du nyttar ordlista, kan det vera til hjelp å lesa om [nynorsk språkføring](https://sprakradet.no/godt-og-korrekt-sprak/praktisk-sprakbruk/nynorskhjelp/).
...
| **bero** | *stille i bero*: utsetja, setja på vent, leggja til side(s), leggja på is, la liggja, venta med; (sterkare:) skrinleggja |
...
| **ivareta** | ta hand om, ta seg av, ta vare på<br>(*ikkje* "ta i vare") |
...
| **myndighet** | styresmakt, styremakt, -makt (som i *påtalemakta*), organ; myndigheit, mynde; (meir spesifikt om kompetanse:) avgjerdsmakt, avgjerdsrett<br><br>*Mynde* blir ikkje brukt om organ/etatar, og *myndigheit* berre sjeldan. Det vanlegaste i fleirtal er *styresmakter*. *Styre(s)makt* blir sjeldan brukt om kompetanse der meir spesifikke ord høver, men ordet kan brukast i den tydinga, til liks med *styringsmakt*. |
...
| **redegjørelse** | utgreiing, framstilling, forklaring, orientering // *aktivitets- og redegjørelsesplikt* aktivitets- og utgreiingsplikt |
...
| **saksbehandling** | saksarbeid, saksbehandling, sakshandsaming, saksførehaving |
| **salg** | sal |
| **samboer** | sambuar |
...
| **sted (et); finne sted** | stad (ein); *gå føre seg, henda, vera* |
...
| **utsatt** | utsett |
| **utslipp** | utslepp |
| **utstede** | ferda ut, skriva ut (blir òg brukt synonymt med *utferdige*, sjå det) |
...
| **øyemed** | <br>augneméd, føremål, siktemål // *i dette ø-* for dette føremålet / med dette for auga / med tanke på dette / i denne samanhengen |
...
---
Kilde: https://sprakradet.no/godt-og-korrekt-sprak/praktisk-sprakbruk/nynorskhjelp/administrativ-ordliste-bokmal-nynorsk/
