...
This skill includes detailed reference material from official Norwegian language resources. For comprehensive reference material, see [references/INDEX.md](references/INDEX.md).
